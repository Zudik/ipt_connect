...
def list_url():
    ...
    urls_external_link = ['https://connect.iptnet.info/',]
    ...
    urls_participants = [urls_menu[4] + '/' + str(i) + '/' for i in numbers_participant]
    urls_physics_f = [urls_menu[0] + '/' + str(i) + '/' for i in numbers_physics_fights]
    urls_problems = [urls_menu[2] + '/' + str(i) + '/' for i in numbers_problem]
    urls_jury = [urls_menu[3] + '/' + str(i) + '/' for i in numbers_jury]

    urls = urls_external_link +  urls_menu[:4] + urls_other  + urls_rounds + urls_teams + urls_participants + urls_problems + urls_jury  # + urls_physics_f
